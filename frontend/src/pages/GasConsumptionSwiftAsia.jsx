...
import ChartSwiftAsiaConsumptionPerTon from "./ChartSwiftAsiaConsumptionPerTon";
// import ChartStriko1ConsumptionPerTon from "./ChartStriko1ConsumptionPerTon";
import ChartSwiftAsiaConsumption from "./ChartSwiftAsiaConsumption";
  ...
  useEffect(() => {
    const fetchUsedYesterdayData = async () => {
      try {
        ...
        const usedyesterdayData = response.data
          .filter((item) => item.nama_mesin === "Swift Asia")
          .map((item) => item.gas_used);
  ...
  useEffect(() => {
    const fetchYesterdayData = async () => {
      try {
        ...
        const yesterdayData = response.data
          .filter((item) => item.nama_mesin === "Swift Asia")
    ...
    <LayoutGas>
      ...
      <div className="columns m-1 ">
        <div className="column is-half has-background-white  ">
          ...
          <ChartSwiftAsiaConsumptionPerTon />
        </div>
      ...
      <div className="columns m-1 ">
        ...
        <div className="column is-half has-background-white ">
          <h1 className="subtitle has-text-centered has-text-weight-semibold is-family-monospace">
            Graphic Gas Used m³
          </h1>
          <ChartSwiftAsiaConsumption />
        </div>
      </div>
    </LayoutGas>
  );
...
export default GasConsumptionSwiftAsia;
